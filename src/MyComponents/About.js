...
export default function (props) {
    return (
        ...
        <video autoPlay muted loop src={props.bgvideo} />
            ...
            <h1>About</h1>
            <hr />
                <p>Aeromodelling is the activity involving design, development and flying of small air vehicles. It is a very exciting and interesting way to learn, apply and understand science and engineering principles.
                    ...
                    While designing an aeromodel is highly based on engineering principles, flying part of Aeromodelling is also considered to be an expensive hobby/ sport.</p>
            </div>
        </div>
        </>
    )
